...
export default function UserModal({ onClose }: UserModalProps) {
  ...
  return (
    <div className="fixed top-10 right-4 z-[200] bg-black/40">
      <div className="relative bg-[#111] text-white rounded-3xl p-4 w-[340px] flex flex-col items-center shadow-xl pointer-events-auto z-[201] opacity-0 translate-y-[-24px] animate-getinmodal border border-[#333]">
        ...
        <div className="w-full mb-4">
          <div className="flex items-center justify-between rounded-xl px-6 py-4 mb-2">
            <button
              onClick={() => { onClose(); router.push('/wallet'); }}
              className="title text-2xl font-bold text-left hover:underline cursor-pointer select-none text-white"
            ...
            <button
              onClick={() => { onClose(); router.push('/wallet'); }}
              className="text-base text-gray-400 text-right hover:underline cursor-pointer select-none"
              style={{ background: "none", border: "none", padding: 0, margin: 0 }}
            >
              Balance
            </button>
        ...
        <div className="grid grid-cols-2 gap-3 w-full mb-2 font-sans text-base">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center bg-[#111] rounded-xl py-4 text-sm hover:bg-[#222] cursor-pointer select-none text-white"
          >
          ...
          <button
            className="flex flex-col items-center justify-center bg-[#111] rounded-xl py-4 text-white text-sm hover:bg-[#222] cursor-pointer select-none"
